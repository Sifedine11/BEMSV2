...
{{-- Sidebar FIXE : reste en place au scroll --}}
<aside class="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-40 flex flex-col">
  <div class="h-16 flex items-center px-4 border-b border-gray-200">
    <span class="text-lg font-bold text-gray-800">Association BEMS</span>
  </div>

  {{-- Container principal : navigation + compte collé en bas --}}
  <div class="flex-1 flex flex-col justify-between">
    ...
    <div class="border-t py-4">
      <ul class="space-y-1">
        <li class="px-3 text-xs uppercase tracking-wider text-gray-400">Compte</li>

        <li>
          <a href="{{ lien('parametres.edit') }}"
             class="group flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium {{ actif('parametres.edit') }}">
            <i class='bx bx-cog'></i>
            <span>Paramètre</span>
          </a>
        </li>
